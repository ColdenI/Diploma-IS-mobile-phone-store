...
{
    public partial class Salon_ViewUserControl : UserControl
    {
        ...
        public Salon_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Salon_ViewForm_Load;
            this.Disposed += Salon_ViewForm_Disposed;
        ...
        private void Salon_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Salon_ViewForm_Load;
            this.Disposed -= Salon_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Salon_AddEditForm(DBT_Salon.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Salon_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Salon.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Salon_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
        ...
        private void UpdateTable()
        {
            ...
            dataGridView.Columns.Add("ID_Salon", "Номер салона");
            dataGridView.Columns.Add("Address", "Адрес");
            dataGridView.Columns.Add("Phone", "Номер телефона");
            dataGridView.Columns.Add("Manager", "Контактное лицо");
            dataGridView.Columns.Add("Region", "Регион");
