...
{
    public partial class Client_ViewUserControl : UserControl
    {
        ...
        public Client_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Client_ViewForm_Load;
            this.Disposed += Client_ViewForm_Disposed;
        ...
        private void Client_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Client_ViewForm_Load;
            this.Disposed -= Client_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Client_AddEditForm(DBT_Client.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Client.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Client_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
        ...
        private void UpdateTable()
        {
            ...
            dataGridView.Columns.Add("ID_Client", "ID_Client"); dataGridView.Columns[0].Visible = false;
            ...
            dataGridView.Columns.Add("RegistrationDate", "Дата регистрации");
                ...
                using (var query = connection.CreateCommand())
                {
                    ...
                    using (var reader = query.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            dataGridView.Rows[index].Cells[5].Value = DateTime.Parse(reader.GetValue(5).ToString());
