...
{
    public partial class Auth_ViewUserControl : UserControl
    {
        ...
        public Auth_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Auth_ViewForm_Load;
        ...
        private void Auth_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Auth_ViewForm_Load;
            this.Disposed -= Auth_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Auth_AddEditForm(DBT_Auth.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Auth_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Auth.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Auth_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
        ...
        private void UpdateTable()
        {
            ...
            dataGridView.Columns.Add("ID_Auth", "ID_Auth"); dataGridView.Columns[0].Visible = false;
                ...
                using (var query = connection.CreateCommand())
                {
                    ...
                    using (var reader = query.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            dataGridView.Rows[index].Cells[1].Value = DBT_Employee.GetById(reader.GetInt32(1)).FullName;
