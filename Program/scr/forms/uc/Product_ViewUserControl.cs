...
{
    public partial class Product_ViewUserControl : UserControl
    {
        ...
        public Product_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Product_ViewForm_Load;
            this.Disposed += Product_ViewForm_Disposed;
        ...
        private void Product_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Product_ViewForm_Load;
            this.Disposed -= Product_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Product_AddEditForm(DBT_Product.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Product_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Product.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Product_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
        ...
        private void UpdateTable()
        {
            ...
            dataGridView.Columns.Add("ID_Product", "ID_Product"); dataGridView.Columns[0].Visible = false;
            ...
            dataGridView.Columns.Add("Warranty", "Гарантия");
