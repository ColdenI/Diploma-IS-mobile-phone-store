...
{
    public partial class Sale_ViewUserControl : UserControl
    {
        ...
        public Sale_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Sale_ViewForm_Load;
            this.Disposed += Sale_ViewForm_Disposed;
        ...
        private void Sale_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Sale_ViewForm_Load;
            this.Disposed -= Sale_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Sale_AddEditForm(DBT_Sale.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Sale.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Sale_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
        ...
        private void UpdateTable()
        {
            ...
            dataGridView.Columns.Add("ID_Sale", "№");
            dataGridView.Columns.Add("ID_Client", "Клиент");
            dataGridView.Columns.Add("ID_Employee", "Сотрудник");
            dataGridView.Columns.Add("ID_Product", "Товар");
            dataGridView.Columns.Add("SaleDate", "Дата");
                ...
                using (var query = connection.CreateCommand())
                {
                    ...
                    using (var reader = query.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            else dataGridView.Rows[index].Cells[1].Value = DBT_Client.GetById(reader.GetInt32(1)).FullName;
                            dataGridView.Rows[index].Cells[2].Value = DBT_Employee.GetById(reader.GetInt32(2)).FullName;
                            dataGridView.Rows[index].Cells[3].Value = DBT_Product.GetById(reader.GetInt32(3)).Name;
